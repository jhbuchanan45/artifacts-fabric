...
public class ToowHandwews {
	...
	public static final Event<ToolManagerImpl.ToolHandler> NON_TOOWS_HANDWEW = EventFactory.createArrayBacked(ToolManagerImpl.ToolHandler.class, ToowManagewImpwAccessow::callToolHandlerInvoker);

	public static void wegistew() {
		NON_TOOWS_HANDWEW.register(new DiggingCwawsToowHandwew(
