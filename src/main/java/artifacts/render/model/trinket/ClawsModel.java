...
public class ClawsModel extends GloveModel {
	...
	public ClawsModel(boolean smallArms) {
		...
		clawLeftUpper1.addCuboid(3 - smallArmsOffset, 10, -1.5F, 1, 4, 1);
		clawRightUpper1.addCuboid(-4 + smallArmsOffset, 10, -1.5F, 1, 4, 1);
		clawLeftUpper2.addCuboid(3 - smallArmsOffset, 10, 0.5F, 1, 4, 1);
		clawRightUpper2.addCuboid(-4 + smallArmsOffset, 10, 0.5F, 1, 4, 1);
		clawLeftLower1.addCuboid(-smallArmsOffset, 10, -1.5F, 3, 5, 1);
		clawRightLower1.addCuboid(-3 + smallArmsOffset, 10, -1.5F, 3, 5, 1);
		clawLeftLower2.addCuboid(-smallArmsOffset, 10, 0.5F, 3, 5, 1);
		clawRightLower2.addCuboid(-3 + smallArmsOffset, 10, 0.5F, 3, 5, 1);
